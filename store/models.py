...
class Contact(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    subject = models.CharField(choices=subject_op,default='Customer service', max_length=500,null=False,blank=False)
    reference = models.ForeignKey(Order, on_delete=models.CASCADE,null=True,blank=True)
...
class Designer(models.Model):
    fname = models.CharField(max_length=150, blank=False, null=False)
    lname = models.CharField(max_length=150, blank=False, null=False)
    designing = models.CharField(max_length=150, blank=False, null=False)
    about = models.TextField()
    phone = models.CharField(max_length=50,null=False)
    email = models.EmailField(max_length=30)
    image1 = models.ImageField(upload_to=get_file_path,blank=False, null=False)
